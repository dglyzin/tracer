...
#define Block0StrideY 13

#define Block0CountX 13
#define Block0CountY 5

#define Block0OffsetX 0.0
#define Block0OffsetY 0.0

#define Block1StrideX 1
#define Block1StrideY 13

#define Block1CountX 13
#define Block1CountY 5
...
void getInitFuncArray(initfunc_fill_ptr_t** ppInitFuncs){
    ...
    *ppInitFuncs = pInitFuncs;
    ...
    pInitFuncs[1] = Block0FillInitialValues;   
}
