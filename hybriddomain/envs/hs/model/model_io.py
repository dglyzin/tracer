...
from hybriddomain.spaces.math_space.pde.bound import Bound
from hybriddomain.spaces.math_space.pde.initial import Initial
from hybriddomain.envs.hs.model.compnode import Compnode
...
class ModelIO():
    ...
    def loadFromFile(self, project_folder=('hybriddomain/problems/1dTests/'
                                           + 'test1d_two_blocks0')):

        '''project_folder is relative path to project folder where
        .json file located (including problems folder).

        Ex: ``hybriddomain/problems/1dTests/test1d_two_blocks0``

           for
              hybriddomain/problems/1dTests/test1d_two_blocks0/test1d_two_blocks0.json
        ...
        if 'problems' not in project_folder:
            ...
            raise(BaseException('path to folder with json must begin from'
                                + ' hybriddomain/problems folder \n'
                                + ' like hybriddomain/problems/1dTests/test1d_two_blocks0'))
