from hybriddomain.envs.hs.model.model_base import ModelBase
from hybriddomain.envs.hs.model.model_io import ModelIO
from hybriddomain.envs.hs.model.model_device import ModelDevice
from hybriddomain.envs.hs.model.cpp.model_gen_cpp import ModelGenCpp
from hybriddomain.envs.hs.model.model_editor import ModelEditor
from hybriddomain.envs.hs.model.grid.grid_main import GridNet as Grid
...
class ModelNet():
    ...
    def readResults(self, names=[],
        ...
        self.result_postproc.get_results_filespaths(self)
