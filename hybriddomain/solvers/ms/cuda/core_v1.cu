...
//=============================BOUNDARY CONDITIONS FOR BLOCK WITH NUMBER 0======================//
//Vertex condition for boundary [0, 2]
__device__ void Block0Default_Vertex0_2__Eqn0(double* result, double** source, double t, int idxX, int idxY, int idxZ, double* params, double** ic){
	 int idx = ( idxX + idxY * Block0StrideY + idxZ * Block0StrideZ) * Block0CELLSIZE;
...
//device side function pointer declaration and init:
__device__ func_ptr_t p_Block0Default_Vertex0_2__Eqn0 = Block0Default_Vertex0_2__Eqn0;



//=============================BOUNDARY CONDITIONS FOR BLOCK WITH NUMBER 0======================//
//Vertex condition for boundary [2, 1]
__device__ void Block0Default_Vertex2_1__Eqn1(double* result, double** source, double t, int idxX, int idxY, int idxZ, double* params, double** ic){
	 int idx = ( idxX + idxY * Block0StrideY + idxZ * Block0StrideZ) * Block0CELLSIZE;
...
//device side function pointer declaration and init:
__device__ func_ptr_t p_Block0Default_Vertex2_1__Eqn1 = Block0Default_Vertex2_1__Eqn1;


//=============================BOUNDARY CONDITIONS FOR BLOCK WITH NUMBER 0======================//
//Vertex condition for boundary [1, 3]
__device__ void Block0Default_Vertex1_3__Eqn2(double* result, double** source, double t, int idxX, int idxY, int idxZ, double* params, double** ic){
	 int idx = ( idxX + idxY * Block0StrideY + idxZ * Block0StrideZ) * Block0CELLSIZE;
     	 result[idx + 0] = 0.0;
     
}
//device side function pointer declaration and init:
__device__ func_ptr_t p_Block0Default_Vertex1_3__Eqn2 = Block0Default_Vertex1_3__Eqn2;



//=============================BOUNDARY CONDITIONS FOR BLOCK WITH NUMBER 0======================//
//Vertex condition for boundary [3, 0]
__device__ void Block0Default_Vertex3_0__Eqn1(double* result, double** source, double t, int idxX, int idxY, int idxZ, double* params, double** ic){
	 int idx = ( idxX + idxY * Block0StrideY + idxZ * Block0StrideZ) * Block0CELLSIZE;
     	 result[idx + 0] = 0.0;
     
}
//device side function pointer declaration and init:
__device__ func_ptr_t p_Block0Default_Vertex3_0__Eqn1 = Block0Default_Vertex3_0__Eqn1;
...
void setup_func_arrays()
{
    ...
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[1], p_Block0DefaultNeumann__Bound0__Eqn0, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[2], p_Block0DefaultNeumann__Bound1__Eqn1, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[3], p_Block0DefaultNeumann__Bound2__Eqn0, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[4], p_Block0DefaultNeumann__Bound3__Eqn3, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[5], p_Block0Default_Vertex0_2__Eqn0, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[6], p_Block0Default_Vertex2_1__Eqn1, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[7], p_Block0Default_Vertex1_3__Eqn2, sizeof(func_ptr_t)));
    checkCudaErrors(cudaMemcpyFromSymbol(&h_funcArray[8], p_Block0Default_Vertex3_0__Eqn1, sizeof(func_ptr_t)));
