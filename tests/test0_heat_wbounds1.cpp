...
void getBlock0BoundFuncArray(func_ptr_t** ppBoundFuncs){
	...
	pBoundFuncs = (func_ptr_t*) malloc( 13 * sizeof(func_ptr_t) );
	*ppBoundFuncs = pBoundFuncs;
	...
	pBoundFuncs[9] = Block0DefaultNeumannBound0;
	pBoundFuncs[10] = Block0DirichletBound0_0;
	pBoundFuncs[11] = Block0DefaultNeumannBound1;
	pBoundFuncs[12] = Block0DirichletBound1_0;
}
