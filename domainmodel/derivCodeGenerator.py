...
#     
#     def __specialMixedDerivativeAlternative(self, blockNumber, parsedMathFunction, increment, generalOrder, fullIndepVarList, indepVarIndex):
...
#                 if k == indepVarIndex:
#                     fullIndepVarValueListR.extend(['(idx' + indepVar.upper() + ' + Block' + str(blockNumber) + 'Offset' + indepVar.upper() + ' * D' + indepVar.upper() + 'M1' + ' + 1)'])
#                 else:
#                     fullIndepVarValueListR.extend(['(idx' + indepVar.upper() + ' + Block' + str(blockNumber) + 'Offset' + indepVar.upper() + ' * D' + indepVar.upper() + 'M1' + ')'])
#             fullIndepVarValueListR.extend(['t'])
#             
#             for k,indepVar in enumerate(fullIndepVarList):
#                 if k == indepVarIndex:
#                     fullIndepVarValueListL.extend(['(idx' + indepVar.upper() + ' + Block' + str(blockNumber) + 'Offset' + indepVar.upper() + ' * D' + indepVar.upper() + 'M1' + ' - 1)'])
#                 else:
#                     fullIndepVarValueListL.extend(['(idx' + indepVar.upper() + ' + Block' + str(blockNumber) + 'Offset' + indepVar.upper() + ' * D' + indepVar.upper() + 'M1' + ')'])
...
#             return '(' + increment + ' * ' + '(' + finiteDifference + ')' + ')'
# 
#     def __specialPureDerivativeAlternative(self, blockNumber, parsedMathFunction, increment, specialIncrement, stride, order, varIndex, fullIndepVarList, leftOrRightBoundary):
...
#             fullIndepVarValueList.extend(['(idx' + indepVar.upper() + ' + Block' + str(blockNumber) + 'Offset' + indepVar.upper() + ' * D' + indepVar.upper() + 'M1' + ')'])
...
#                     return self.__specialPureDerivativeAlternative(blockNumber, parsedMathFunction, increment, specialIncrement, stride, order, varIndex, userIndepVariables, 1)
#                 elif (side - 1) % 2 == 0 and indepVarIndexList[0] == (side - 1) / 2:
#                     return self.__specialPureDerivativeAlternative(blockNumber, parsedMathFunction, increment, specialIncrement, stride, order, varIndex, userIndepVariables, 0)
#                 else:
#                     return self.__commonPureDerivativeAlternative(blockNumber, increment, stride, order, varIndex)
...
#                 return self.__specialMixedDerivativeAlternative(blockNumber, parsedMathFunction, specialIncrement, generalOrder, userIndepVariables, 1)
...
#                 specialIncrement = 'D' + indepVarList[ind].upper() + 'M' + derivativeOrderList[ind]
#                 return self.__specialMixedDerivativeAlternative(blockNumber, parsedMathFunction, specialIncrement, generalOrder, userIndepVariables, 2)
...
#                 specialIncrement = 'D' + indepVarList[ind].upper() + 'M' + derivativeOrderList[ind]
#                 return self.__specialMixedDerivativeAlternative(blockNumber, parsedMathFunction, specialIncrement, generalOrder, userIndepVariables, 0)
#             else:
