...
def getResults1D((projectDir, projectName, binFile, info, countZ, countY, countX, offsetZ, offsetY, offsetX, cellSize, nameEquations, resultExpression, idx)):
    '''
...
def createMovie(projectDir, projectName):
    ...
    for resultItem in resultList:
        ...
        resuls = pool.map(getResults1D, [(projectDir, projectName, binFile, info, countZ, countY, countX, offsetZ,
                                                offsetY, offsetX, cellSize, namesEquations, resultItem['Value'],
