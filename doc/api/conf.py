...
project_paths.append(os.path.abspath('../../gens/hs/env'))
project_paths.append(os.path.abspath('../../gens/hs/env/array'))
project_paths.append(os.path.abspath('../../gens/hs/env/base'))
project_paths.append(os.path.abspath('../../gens/hs/env/bounds'))
project_paths.append(os.path.abspath('../../gens/hs/env/bounds/common'))
project_paths.append(os.path.abspath('../../gens/hs/env/bounds/d1'))
project_paths.append(os.path.abspath('../../gens/hs/env/bounds/d2'))
project_paths.append(os.path.abspath('../../gens/hs/env/centrals'))
project_paths.append(os.path.abspath('../../gens/hs/env/common'))
project_paths.append(os.path.abspath('../../gens/hs/env/definitions'))
project_paths.append(os.path.abspath('../../gens/hs/env/ics'))
project_paths.append(os.path.abspath('../../gens/hs/env/ics/d1'))
project_paths.append(os.path.abspath('../../gens/hs/env/ics/d2'))
project_paths.append(os.path.abspath('../../gens/hs/env/initials'))
project_paths.append(os.path.abspath('../../gens/hs/env/params'))
